    ...
    <div className=" w-full h-screen flex flex-col gap-5">
      ...
      <CustomTabPanel value={value} index={0}>
        <div className="px-10  flex flex-col ">
          <div className=" w-full py-2 flex flex-col gap-5 justify-center items-center">
            <div className="w-2/3 flex flex-row justify-between items-center bg-blue-100 py-5 px-2">
      ...
      <CustomTabPanel value={value} index={1}>
        <div className="flex flex-col w-full ">
          <div className=" py-2 flex flex-col gap-5 justify-center items-center ">
            <div className="w-2/3 flex flex-row justify-between items-center bg-blue-100 py-5 px-2">
