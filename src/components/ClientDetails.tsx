...
const ClientDetails = () => {
  ...
  return (
    ...
    <div className="flex flex-col  w-2/3  gap-10 px-5 py-20 ">
      ...
      {clientDetails.map((client) => (
        <tbody key={client._id}>
          <tr className="text-sm text-neutral-600 border px-4 py-4">
            <td className="flex-1 p-2 font-semibold">Client ID</td>
            <td className="flex-1 p-2">{client.clientId}</td>
            <td className="flex-1 p-2 font-semibold">Client Name</td>
            <td className="flex-1 p-2 uppercase">{client.clientName}</td>
          </tr>
          <tr className="text-sm text-neutral-600 border px-4 py-2">
            <td className="flex-1 p-2 font-semibold">Address</td>
          ...
          <tr className="text-sm text-neutral-600 border px-4 py-2">
            ...
            <td className="flex-1 p-2">India</td>
          </tr>
          <tr className="text-sm text-neutral-600 border px-4 py-2">
          ...
          <tr className="text-sm text-neutral-600 border px-4 py-2 b">
            <td className="flex-1 p-2 font-semibold">Currency</td>
            <td className="flex-1 p-2">INR</td>
            <td className="flex-1 p-2 font-semibold">Email</td>
            <td className="flex-1 p-2">{client.mailAddress}</td>
          </tr>
        </tbody>
      ))}
    </table>
