          ...
          <table className="w-full border">
            <tbody>
              <tr className="text-sm text-neutral-600  border px-4 py-2">
                ...
                <td className="flex-1 ">201</td>
                <td className="flex-1 font-semibold">Client Name</td>
                <td className="flex-1 uppercase">PATEL TOOL INDUSTRY</td>
              </tr>
              <tr className="text-sm text-neutral-600  border px-4 py-2">
                <td className="flex-1 font-semibold ">Address</td>
                <td className="flex-1">886/1,Behind HMT Factory,MIDC,Shiroli</td>
                <td className="flex-1 font-semibold">City</td>
                <td className="flex-1">Kholapur</td>
              </tr>
              <tr className="text-sm text-neutral-600  border px-4 py-2">
              ...
              <tr className="text-sm text-neutral-600  border px-4 py-2">
                ...
                <td className="flex-1">416122</td>
                <td className="flex-1 font-semibold">Phone</td>
                <td className="flex-1">9422048283</td>
              </tr>
              <tr className="text-sm text-neutral-600  border px-4 py-2">
