...
const NewBilling = () => {
  ...
  const handleSelectChange = (type: any, value: any) => {
    ...
    const selectedClient = formData.clients.find((client) => client.clientName === value);
  ...
  return (
    <form
      ...
      className="flex flex-col justify-center items-center w-full h-screen gap-10 px-5 py-14  "
    >
